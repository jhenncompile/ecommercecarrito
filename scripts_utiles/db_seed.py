...
def main():
    ...
    try:
        nt = int(input("¿Tiendas nuevas? [0]: ") or 0)
        nc = int(input("¿Clientes nuevos? [0]: ") or 0)
        pp = int(input("¿Productos A AÑADIR por tienda? [10]: ") or 10)
        op = int(input("¿Pedidos A GENERAR por cliente? [2]: ") or 2)
