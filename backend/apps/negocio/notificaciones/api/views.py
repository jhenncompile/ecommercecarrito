...
from apps.negocio.notificaciones.api.serializers import NotificacionSerializer
from apps.customers.users.authentication import ClienteJWTAuthentication
