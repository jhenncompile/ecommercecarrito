...
from apps.negocio.catalogo.models.categoria import Categoria
...
from apps.negocio.billing.models.detalle_factura import DetalleFactura
from apps.negocio.reportes.services.behavior_service import CustomerBehaviorService
